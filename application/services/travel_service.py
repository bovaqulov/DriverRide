...
class TravelServiceAPI(BaseService):
    ...
    async def update_travel_status(self, travel_id: int, status: str) -> Dict[str, Any]:
        """
        Update travel status using the custom action
        ...
        return await self._request(
            "POST",
            f"/travels/{travel_id}/update_status/",
            json={"status": status}
        )
